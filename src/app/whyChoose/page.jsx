        ...
        <section className="my-20 px-6 md:px-40">
          ...
          >
            ...
            <div>
              <p className="text-2xl md:text-3xl leading-9 mb-10">
                ...
                experience and speed. Our platform keeps users engaged and
                agents empowered.
              </p>
          ...
          >
            ...
            <div className="max-w-md mt-10 md:mt-0 text-center md:text-left">
              ...
              <p className="text-lg text-gray-500 mt-4">
                Lasting cooperation on a project allows us to fully understand
                the product and apply our know-how.
              </p>
          ...
          >
            ...
            <div className="max-w-xl">
              <h1 className="text-2xl font-semibold">
                ...
                feedback and facts that help you avoid setbacks and save
                resources in the long run.
              </h1>
              <p className="text-blue-500 text-xl mt-4">
                Learn more <span className="underline">About us</span> and see
                how we operate.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="max-w-2xl">
              <h1 className="text-xl">
                A functional product is a great satisfaction, but being
                recognized is cool too. Our work has been awarded by
                organizations like Awwwards, FWA or CSSDA.
              </h1>
              <p className="text-blue-500 mt-2">
